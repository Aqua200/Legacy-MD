...
```
```bash
git clone https://github.com/Aqua200/Legacy-MD && cd Legacy-MD
```
```bash
yarn install
```
...
```bash
cd && cd Legacy-MD && npm start
```
----
### Obtener nuevo código QR 
> *Detén el bot, haz click en el símbolo (ctrl) [default=z] usar la letra "z" + "ENTER" hasta que salga algo verdes similar a: `Legacy-MD $`*
> **Escribe los siguientes comandos uno x uno :**
```bash 
cd && cd Legacy-MD && rm -rf sessions/Principal && npm run qr
```
----
### Obtener nuevo código de teléfono 
```bash 
cd && cd Legacy-MD && rm -rf sessions/Principal && npm run code
```
</details>

<details>
<summary><b>❀ Actualizar Legacy-MD</b></summary>
...
```bash
cd && cd Legacy-MD && nano settings.js
```
...
* Grupo Oficial [`¡Click aquí!`](https://chat.whatsapp.com/C3kWsE6dRihI92oxztTXR9?mode=wwt)
* Comunidad Oficial [`¡Click aquí!`](https://chat.whatsapp.com/CHXQizfRDItFdWM8F217oB?mode=wwt)
</details>

<details>
<summary><b> ✰ Contáctos</b></summary>

* WhatsApp: [`Aquí`](https://wa.me/526631079388)
* Correo: [`Aquí`](wup2140@gmail.com)
</details>
